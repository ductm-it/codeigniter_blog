...
<head>
    ...
    <!-- ========== Favicon Icon ========== -->
    <link rel="shortcut icon" href="assets/user/img/favicon.png" type="image/x-icon">
    ...
    <link href="assets/user/css/owl.carousel.min.css" rel="stylesheet" />
    <link href="assets/user/css/owl.theme.default.min.css" rel="stylesheet" />
    <link href="assets/user/css/animate.css" rel="stylesheet" />
    <link href="assets/user/css/bootsnav.css" rel="stylesheet" />
    ...
    <!--[if lt IE 9]>
      <script src="assets/user/js/html5/html5shiv.min.js"></script>
      <script src="assets/user/js/html5/respond.min.js"></script>
    <![endif]-->
...
<body>
                ...
                <nav id="mainNav" class="navbar navbar-default navbar-fixed white bootsnav on no-full nav-box no-background">
                    ...
                    <div class="container">            
                        ...
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="index.html"><img src="assets/user/img/logo.png" class="logo" alt="Logo"></a>
                        </div>
    ...
    <!-- Start Banner 
    ============================================= -->
    <div class="banner-area content-double box-nav background-move bg-gray" style="background-image: url(assets/user/img/bg-2.png);">
        <div class="container">
            <div class="row">
                <div class="double-items">
                    ...
                    <div class="col-md-6 right-info">
                        <div class="thumb animated">
                            <img src="assets/user/img/illustrations/1.png" alt="Thumb">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="process-items">
                    <div class="col-md-6 thumb">
                        <img src="assets/user/img/illustrations/4.svg" alt="Thumb">
                    </div>
            ...
            <div class="row">
                <div class="team-items text-center">
                    ...
                    <div class="col-md-4 equal-height single-item">
                        <div class="item">
                            <div class="thumb">
                                <img src="assets/user/img/800x800.png" alt="Thumb">
                                <ul>
                                    <li class="facebook">
            ...
            <div class="row">
                <div class="blog-items">
                    ...
                    <div class="col-md-4 single-item">
                        <div class="item">
                            <div class="thumb">
                                <a href="#"><img src="assets/user/img/800x600.png" alt="Thumb"></a>
                            </div>
                            <div class="info">
                                <div class="content">
                                    <div class="date">
                                ...
                                <div class="meta">
                                    <ul>
                                        <li>
                                            <a href="#">
                                                <img src="assets/user/img/100x100.png" alt="Author">
                                                <span>Author</span>
                                            </a>
                                        </li>
                                        <li>
            ...
            <div class="row">
                <div class="contact-items">
                    ...
                    <div class="col-md-4 thumb">
                        <img src="assets/user/img/illustrations/5.png" alt="Thumb">
                    </div>
                    <!-- End Thumb -->
                    
                    <!-- Contact Form -->
                    <div class="col-md-7 col-md-offset-1 contact-form">
                        <form action="assets/user/mail/contact.php" method="POST" class="contact-form">
                            <div class="col-md-12">
                                <div class="row">
    ...
    <!-- jQuery Frameworks
    ============================================= -->
    <script src="assets/user/js/jquery-1.12.4.min.js"></script>
    <script src="assets/user/js/bootstrap.min.js"></script>
    <script src="assets/user/js/equal-height.min.js"></script>
    ...
    <script src="assets/user/js/jquery.backgroundMove.js"></script>
    <script src="assets/user/js/bootsnav.js"></script>
